...
export const Footer: React.FC = ({ }) => {
    ...
    return (
        <div>
            <div className="fixed bottom-0 left-0 right-0 bg-gray-900 p-2 lg:p-1 h-14 lg:flex justify-between hidden">
                    ...
                    <div className="flex">
                        ...
                        <button className="btn btn-ghost mx-1">
                            <a href="http://mintgame.soljunks.io/" target="_blank">
                                <img src="./button/game.png" className="w-12" />
                            </a>
                        </button>
                        <button className="btn btn-ghost mx-1" onClick={toggleInfoModal}>
                            <p className="font-pixel text-xl">NFTS</p>
                        </button>
                    </div>
                </div>
