...
export const MultiMintButton = ({
    ...
    return (
        <div>
            <div className="lg:flex justify-center mx-5 hidden">
            ...
            {/* MOBILE VIEW */}
            <div className="lg:hidden block justify-center mx-5">
                <button className="btn btn-primary w-32 mb-5 font-bold"
                    disabled={
                        clicked ||
                        candyMachine?.state.isSoldOut ||
                        isSoldOut ||
            ...
            {!candyMachine?.state.isSoldOut && !isSoldOut && isActive &&
                <h3 className="my-4 font-trash uppercase">Total estimated cost + fees: <p className="font-bold">{totalCost} SOL</p></h3>}
            {mintCount > 10 ? (
                <div className="justify-between hidden lg:flex">
                    <h3 className="align-middle text-white bg-red-600 rounded-box p-3 h-28 font-trash uppercase">
                        ...
                        <br /></h3>
                    <button className="btn btn-primary h-28 font-trash uppercase"
