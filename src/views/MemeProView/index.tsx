      ...
      <div className="hidden lg:flex">
        <div className='grid grid-cols-4'>
          ...
          <div className="grid grid-rows-8 gap-4 bg-gray-900">
            <div className="row-span-1 grid grid-cols-5 p-2 text-center">
              <button className="font-pixel btn btn-primary btn-sm rounded col-span-1" onClick={() => prevTheme()}>⏪</button>
              {theme == 1 && <h1 className="font-pixel text-3xl rounded w-auto col-span-3">GEN 2 THEME</h1>}
              {theme == 2 && <h1 className="font-pixel text-3xl rounded w-auto col-span-3">RUDECANS THEME</h1>}
              {theme == 3 && <h1 className="font-pixel text-3xl rounded w-auto col-span-3">CUSTOM THEME</h1>}
              <button className="font-pixel btn btn-primary btn-sm rounded col-span-1" onClick={() => nextGen2Theme()}>⏩</button>
            </div>
            <div className='mt-4'>
              {theme == 1 &&
                <div className="p-2">
              ...
              {theme == 3 &&
                <div className="p-2">
                  <form className="mb-2">
                    <label htmlFor="file" className="btn btn-secondary w-full font-pixel">
                  ...
                  <form className="mb-2">
                    <label htmlFor="file2" className="btn btn-secondary w-full font-pixel">
                      Select file for Layer 1
                      <input
                        id="file2"
                        type="file"
                        name="file2"
                  ...
                  <form className="mb-2">
                    <label htmlFor="file3" className="btn btn-secondary w-full font-pixel">
                      Select file for Layer 2
                      <input
                        id="file3"
                        type="file"
                        name="file3"
                  ...
                  <form className="mb-2">
                    <label htmlFor="file4" className="btn btn-secondary w-full font-pixel">
                      Select file for Layer 3
                      <input
                        id="file4"
                        type="file"
                        name="file4"
                  ...
                  <form className="mb-2">
                    <label htmlFor="file5" className="btn btn-secondary w-full font-pixel">
                      Select file for Layer 4
                      <input
                        id="file5"
                        type="file"
                        name="file5"
                  ...
                  <form className="mb-2">
                    <label htmlFor="file6" className="btn btn-secondary w-full font-pixel">
                      Select file for Layer 5
                      <input
                        id="file6"
                        type="file"
                        name="file6"
            ...
            <div className={`w-[800px] h-[800px] container text-center`} id="canvasDesktop">
              <div className="relative">
                ...
                {theme == 2 &&
                  ...
                  <div>
                    {/* BG */}
                    <img src={selectedCustomLayer1} alt='' />
                    {/* Layer 1 */}
                    <span className="absolute top-0 left-0">
                      <img src={selectedCustomLayer1} alt='' />
                    </span>
