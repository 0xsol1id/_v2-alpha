        ...
        <div className='flex'>
            <div className="dropdown">
                ...
                <ul tabIndex={0} className="mt-1 text-md shadow menu dropdown-content bg-base-300 rounded border border-gray-500 w-[12rem]">
                    <li>
                        <a href="https://magiceden.io/marketplace/soljunk" target="_blank">
                            <p className="font-pixel text-sm uppercase">BUY SolJunk GEN1</p>
                        </a>
                    </li>
                    <li>
                        <a href="https://magiceden.io/marketplace/solana_money_business" target="_blank">
                            <p className="font-pixel text-sm uppercase">BUY $MB</p>
                        </a>
                    </li>
                    <li>
                        <a href="https://magiceden.io/marketplace/faces_of_solana_money_business" target="_blank">
                            <p className="font-pixel text-sm uppercase">BUY Faces of $MB</p>
                        </a>
                    </li>
                    <li>
                        <a href="https://magiceden.io/marketplace/lil_rektie" target="_blank">
                            <p className="font-pixel text-sm uppercase">BUY Lil Rektie</p>
                        </a>
                    </li>
                    <li>
                        <a href="https://magiceden.io/marketplace/harrddyjunks" target="_blank">
