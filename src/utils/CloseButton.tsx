...
export const CloseButton: FC<Props> = ({
    ...
    return (
        <div>
            {!isclosing &&
                <button className="btn btn-ghost border-gray-800 w-full font-trash uppercase tooltip tooltip-right" data-tip="Close empty accounts" onClick={() => { if (publicKey) CloseAccount(toClose, publicKey, wallet, connection, setIsClosing, setMessage, setRefresh, setCurrentTx, setTotalTx); else setVisible(true) }}>CLOSE {toClose.length} EMPTY ACCOUNTS</button>
            }

            {isclosing && 
                <button className="btn btn-primary w-full uppercase font-trash uppercase">
