...
export const TokenIconEA = (props: { account: string, connection: Connection, metaplex: Metaplex }) => {
  ...
  return (
    <div>
      ...
      {isNFT == true &&
        <img className="font-pixel bg-gray-800 object-cover h-12 lg:h-12 rounded" src={uri} />
      }
      {isClosed == true &&
        <img className="font-pixel bg-gray-800 object-cover h-12 lg:h-12 rounded" src={proxy.src} />
      }
