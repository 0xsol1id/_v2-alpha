...
export const BurnButton: FC<Props> = ({
    ...
    return (
        <div>
            {!isburning &&
                <button className="btn btn-primary w-full font-trash uppercase" onClick={() => { if (publicKey) burnTokenAndCloseAccount(toBurn, publicKey, wallet, connection, setIsburning, setMessage, setRefresh, setCurrentTx, setTotalTx); else setVisible(true) }}>BURN SELECTED</button>
            }
